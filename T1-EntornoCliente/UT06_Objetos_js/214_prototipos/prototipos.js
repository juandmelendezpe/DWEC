...
class Punto {
    constructor(cordX, coordY) {
        ...
        this.x = cordX;
        this.y = coordY;
        // Define un método para mostrar las coordenadas del punto
        this.mostrarCoordenadas = () => `(${this.x}, ${this.y})`;
    }
}

// Función para mostrar el prototipo del objeto
function prototipo() {
    // Crea una nueva instancia de Punto con coordenadas (10, 20)
...
// Función para añadir propiedades al prototipo
...
// Función para mostrar dos objetos y sus prototipos
...
// Función para modificar las propiedades del prototipo
function modificarPropiedadesDePrototipo() {
    // Crea dos instancias de Punto
    let a = new Punto(10, 20);
    let b = new Punto(-3, 6);
    // Añade un método y una propiedad al prototipo de Punto
    Punto.prototype.sumarXY = function () {
        return this.x + this.y;
    };
    Punto.prototype.z = 0;
    // Modifica la propiedad z del objeto a y del prototipo de b
